        <nav class="bg-gray-800" x-data="{ isOpen: false }">
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <x-nav-link href="/" class="block text-base">Home</x-nav-link>
                    <x-nav-link href="/posts" class="block text-base">Blog</x-nav-link>
                    <x-nav-link href="/about" class="block text-base">About</x-nav-link>
                    <x-nav-link href="/contact" class="block text-base">Contact</x-nav-link>
                </div>
